...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('serial_no_triggers', function (Blueprint $table) {
            ...
            $table->string('lot_no')->after('serial_no');// LOTNO
            $table->string('case_id')->nullable()->after('lot_no');// CASEID
            $table->string('case_no')->after('case_id');// CASENO
            ...
            $table->string('shelve')->nullable()->after('qty');// SHELVE
            $table->string('pallet_no')->nullable()->after('shelve');// PALLETKEY
