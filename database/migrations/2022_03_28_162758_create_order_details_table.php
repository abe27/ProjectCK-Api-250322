...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('order_details', function (Blueprint $table) {
            ...
            $table->decimal('order_orgi', 64, 2)->nullable()->default(0);// t.ORDERORGI,
            $table->decimal('order_round', 64, 2)->nullable()->default(0);// t.ORDERROUND,
            $table->decimal('order_balqty', 64, 2)->nullable()->default(0);// t.BALQTY,
            $table->decimal('order_stdpack', 64, 2)->nullable()->default(0);// t.BISTDP,
            $table->string('shipped_flg', 2);// t.SHIPPEDFLG,
            $table->decimal('shipped_qty', 64, 2)->nullable()->default(0);// t.SHIPPEDQTY,
