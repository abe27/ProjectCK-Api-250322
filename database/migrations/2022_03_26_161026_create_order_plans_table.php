...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('order_plans', function (Blueprint $table) {
            ...
            $table->decimal('shippedqty', 8, 2)->nullable()->default(0);// "shippedqty": float(str(self.__trimtxt(line[109 : (109 + 9)]))),
            $table->date('ordermonth')->nullable();// "ordermonth":
            $table->decimal('balqty', 8, 2)->nullable();// "balqty": float(str(self.__trimtxt(line[126 : (126 + 9)]))),
            ...
            $table->decimal('bistdp', 8, 2)->nullable()->default(0);// "bistdp": float(str(self.__trimtxt(line[165 : (165 + 9)]))),
            $table->decimal('binewt', 8, 2)->nullable()->default(0);// "binewt": float(str(self.__trimtxt(line[174 : (174 + 9)]))),
            $table->decimal('bigrwt', 8, 2)->nullable()->default(0);// "bigrwt": float(str(self.__trimtxt(line[183 : (183 + 9)]))),
            ...
            $table->decimal('biwidt', 8, 2)->nullable()->default(0);// "biwidt": float(str(self.__trimtxt(line[212 : (212 + 4)]))),
            $table->decimal('bihigh', 8, 2)->nullable()->default(0);// "bihigh": float(str(self.__trimtxt(line[216 : (216 + 4)]))),
            $table->decimal('bileng', 8, 2)->nullable()->default(0);// "bileng": float(str(self.__trimtxt(line[208 : (208 + 4)]))),
